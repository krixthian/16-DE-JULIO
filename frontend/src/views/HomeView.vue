...
<template>
  <section class="p-4 md:p-8 max-w-7xl mx-auto text-slate-900 dark:text-slate-100">
    ...
    <div class="mt-6 p-6 rounded-xl border border-slate-200 dark:border-slate-700"><h2 class="font-semibold">Alertas de riesgo</h2><p class="text-slate-500 dark:text-slate-400 mt-2">La evaluación predictiva todavía no está disponible. Tareas y XGBoost se incorporarán en la siguiente etapa.</p></div>
  </section>
</template>
