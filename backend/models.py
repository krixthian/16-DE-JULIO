...
class Usuario(Base):
    ...
    requiere_cambio_password = Column(Boolean, nullable=False, server_default=text('FALSE'))
    password_temporal_vence_en = Column(DateTime, nullable=True)
    credencial_version = Column(SMALLINT(unsigned=True), nullable=False, server_default=text('0'))
